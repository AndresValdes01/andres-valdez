          ...
          <fieldset>
            ...
            <div>
              <div className="input-group flex-nowrap">
                ...
                <input type="number" className="form-control" placeholder="Identificador de Venta" />
              </div>
              <div className="input-group flex-nowrap">
                <span className="input-group-text" id="addon-wrapping">
                  ID Producto
                </span>
                <input type="number" className="form-control" placeholder="Identificador de Producto" />
              </div>
              <div className="input-group flex-nowrap">
                <span className="input-group-text" id="addon-wrapping">
                  Cantidad
                </span>
                <input type="number" className="form-control" placeholder=" Numero de Elementos" />
              </div>
              <div className="input-group flex-nowrap">
                <span className="input-group-text" id="addon-wrapping">
                  Precio Unitario
                </span>
                <input type="tel" className="form-control" placeholder=" Precio Unidad" />
              </div>
              <div className="input-group flex-nowrap">
                <span className="input-group-text" id="addon-wrapping">
                  Valor Total
          ...
          <div className="card text-center">
            <div className="card-header">Vita Family</div>
              <div className="card-body">
                ...
                <a href="#" className="btn btn-success btn1">Ir a Inicio</a>
              </div>
